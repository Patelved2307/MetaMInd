...
export const PromptInputBox = React.forwardRef((props: PromptInputBoxProps, ref: React.Ref<HTMLDivElement>) => {
  const { onSend = () => {}, isLoading = false, placeholder = "Type your message here...", className, value: propValue, onValueChange: propOnValueChange } = props;
  const [internalInput, setInternalInput] = React.useState("");
  const input = propValue !== undefined ? propValue : internalInput;
  const setInput = propOnValueChange || setInternalInput;
