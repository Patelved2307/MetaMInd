...
export const OnboardingPage: React.FC = () => {
  ...
  return (
    <div className="h-screen w-full bg-[#F8FAFC] text-slate-800 flex flex-col lg:flex-row gap-4 p-3 sm:p-4 overflow-hidden relative selection:bg-blue-100 font-sans">
      {/* Dynamic Radial Ambient Theme Sheen */}
      <div
        className="fixed top-0 right-0 w-[650px] h-[650px] rounded-full blur-[140px] pointer-events-none opacity-20 z-0 transition-all duration-700"
        style={{ background: theme.glow }}
      />
      <div
        className="fixed bottom-0 left-1/4 w-[500px] h-[500px] rounded-full blur-[120px] pointer-events-none opacity-15 z-0 transition-all duration-700"
        style={{ background: theme.glow }}
      />
